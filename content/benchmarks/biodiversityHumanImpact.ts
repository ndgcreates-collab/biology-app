...
export const biodiversityHumanImpact: Benchmark = {
  ...
  vocabulary: [
    { term: "Eutrophication", definition: "When excess nutrients (often fertilizer runoff) trigger an algal bloom in water that blocks light and depletes oxygen, killing aquatic life." },
    { term: "Deforestation", definition: "The large-scale clearing of forests, which destroys habitat and reduces biodiversity." },
    { term: "Bioaccumulation", definition: "The buildup of a toxin inside a single organism over its lifetime, as it takes in the toxin faster than it can get rid of it." },
    { term: "Biomagnification", definition: "The increase in toxin concentration at each higher trophic level of a food chain, so top predators carry the highest concentrations." },
  ...
  diagramKeys: ["eutrophication", "deforestation", "biomagnification"],
  meta: draftMeta(),
};
